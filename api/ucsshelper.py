...
class UcssHelper:
    ...
    def process_catv_request(self):
        print("process_catv_request called")
        # serializer_map = {
        ...
        # print("serializer_cls", serializer_cls)
        print("self.token_type",self.token_type)
        print("self.search_type", self.search_type)
        request_data = {
        ...
        print("process_catv_request", request_data)
