...
ELASTICSEARCH_INDEX_NAMES = {
    'search_indexes.documents.role': 'dev_role',
    'search_indexes.documents.user': 'dev_user',
    'search_indexes.documents.case': 'dev_case',
    'search_indexes.documents.indicator': 'dev_indicator',
}
